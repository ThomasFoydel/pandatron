...
let Store = ({ children }) => {
  const stateHook = React.useReducer(() => {}, {})
...
//   analyzerBufferLength = analyzer.frequencyBinCount
//   analyzerData = new Uint8Array(analyzerBufferLength)
// }
...
if (typeof window !== 'undefined') {
  ...
  function reducer(state, action) {
    ...
    switch (action.type) {
      ...
      // make sure these are in init vals
